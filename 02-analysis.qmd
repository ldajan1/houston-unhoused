...
3. Judgement and dispositions
    ...
    iv) What is the month with the most guilty dispositions percentage?
    v) What is the average percentage of guilty dispositions for each month since 2016?
4. People Analysis
...
What is monthly guilty count?
What is total monthly disposition count?
guilty/total * 100

```{r}
unhoused |> 
  filter(judgment_date >= "2023-07-01") |> # i'm looking 6 months before Whitmire's term started to see if there is an uptick in citations after Jan. 2024. @ create flag for this
  group_by(jud_yr,
           jud_mo_label) |> 
  summarise(guilty = n(disposition == "GUILTY TRIAL BY JUDGE")
  # group_by(jud_yr,
  #          jud_mo_label) |>
  # summarise(guilty = n(disposition == "GUILTY TRIAL BY JUDGE"),
  #           total = n())
...
* Ever: The month with the guilty dispositions since 2016 is Aug. 2021, with 829 dispositions, followed by Apr. 2021 with 777. The month with the lowest guilty dispositions since 2016 is May 2020 with 5 dispositions.
* Whitmire: The month with the highest guilty dispositions since July 2023 is May 2024 with 771 guilty dispositions, followed by Sep. 2025 with 704 citations. The month with the lowest guilty dispositions since July 2023 is Jul. 2023 with 104 dispositions, followed by Dec. 2024 with 136.
